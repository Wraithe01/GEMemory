...
static void AllocTest()
{
    ...
    tester.Validate(pool, DEFAULT_NODE_SIZE + sizeof(uint8_t*), "Default Pool Test");
    ...
    tester.ThreadTest(tsStack, 4, TEST_NUM_THREAD_REGIONS, "Thread Stack Test");
    tester.ThreadTest(tsPool, 4, TEST_NUM_THREAD_REGIONS, "Thread Pool Test");
}
